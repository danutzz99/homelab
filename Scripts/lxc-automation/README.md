...
| `automation-stack.yaml` | Example Automation LXC container stack for Vault and Tautulli |
...
then runs the Vault recovery helper. This keeps Vault and monitoring data from
starting against empty or missing storage.
