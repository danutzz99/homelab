...
ENDPOINTS:
    ...
    POST /wol     - Trigger Wake-on-LAN and send a notification

CONFIGURATION:
    PROXMOX_MAC_ADDRESS      Runtime Wake-on-LAN target
    NOTIFICATION_WEBHOOK_URL Runtime notification endpoint
...
def wake_on_lan():
    """Trigger Wake-on-LAN for Proxmox and send a notification."""
    try:
        ...
        # Notify the configured alert channel.
