...
"""
=============================================================================
gogu_bot.py - Operator Command Bot For Homelab Control
=============================================================================

PURPOSE:
    Operator command bot that provides remote control of the homelab.
...
CONFIGURATION:
    ...
    DISCORD_TOKEN_SECRET_PATH Runtime secret path for the bot token
...
def get_discord_token():
    """Fetch the bot token from Vault or environment."""
    try:
...
if not TOKEN:
    raise ValueError("Could not retrieve bot token")
