...
These notes summarize the mail-classifier workflow pattern used for mail labeling, stale-label cleanup, and notifications.

## Recommended Workflow Shape

1. scheduled trigger
2. optional manual trigger
3. mail label fetch
4. mail message fetch
5. merge with `labelMap`
6. per-item classifier
7. mail add-label step
8. mail remove-label step
9. optional review workflow
