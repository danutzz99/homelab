...
This directory documents an n8n workflow set for mail classification, label cleanup, and notification-based observability.
...
- `review-notifier-workflow.json`
  Optional child workflow for manual-review messages.

- `error-notifier-workflow.json`
  Optional error workflow for alerts.
...
| `02-label-map/` | Mail labels, fetched messages, and merge setup | [Open](./02-label-map/) |
...
| `06-review-notifier/` | Optional review path | [Open](./06-review-notifier/) |
