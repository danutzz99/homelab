...
This section covers the optional review flow for edge cases.
...
If one of those signals is present, the workflow formats a review message with the message subject, sender, labels, and review reason.
...
- [review-notifier-workflow.json](../review-notifier-workflow.json)
