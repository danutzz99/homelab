...
3. removes stale or conflicting labels from mail provider

## Why It Matters

Without this step, mail messages can keep old primary-category labels and end up looking like they belong to more than one category at the same time.
