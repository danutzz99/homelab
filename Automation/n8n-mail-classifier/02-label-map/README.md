...
The workflow begins by fetching all mail labels and building a lookup object shaped like:
...
That lookup is merged with the fetched messages so the classifier can resolve human-readable label names into mail label IDs during the run.
